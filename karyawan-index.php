    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="karyawan-tambah.php" class="btn btn-sm btn-success float-right">+ Tambah Data</a>
        </div>
        <div class="card-body">
        <table class="table table-bordered" id="example2">
          ...
          <tr>
            ...
            <td><?= $row['jabatan']; ?></td>
            <td><?= $row['alamat']; ?></td>
            <td><?= ($row['status_aktif'] == 'aktif') ? 'Aktif' : 'Nonaktif'; ?></td>
            <td style="text-align: center;">
                <a href="karyawan-edit.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
